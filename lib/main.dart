...
class _DemoHoverEmojiState extends State<DemoHoverEmoji> with SingleTickerProviderStateMixin {
        ...
        Builder(
          builder: (context) {
            ...
            return AnimatedEmoji(
              emoji.hasSkinTones ? (emoji as AnimatedTonedEmojiData).mediumLight : emoji,
            );
          },
        ),
      ],
